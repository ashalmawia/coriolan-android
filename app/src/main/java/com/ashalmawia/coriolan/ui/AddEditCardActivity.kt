...
class AddEditCardActivity : BaseActivity() {
    ...
    data class Dependencies(val repository: Repository, val domain: Domain)
    private val dependencies: Dependencies by lazy { (applicationContext as CoriolanApplication).dependencies.addEditCardActivity }

    private val repository: Repository by lazy { dependencies.repository }
    private val domain: Domain by lazy { dependencies.domain }
