...
fun  List<Task>.new() = this.filter { it.learningProgress.spacedRepetition.status == Status.NEW }
fun  List<Task>.review() = this.filter { it.learningProgress.spacedRepetition.status != Status.NEW }