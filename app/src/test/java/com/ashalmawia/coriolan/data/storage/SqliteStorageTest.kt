...
import com.ashalmawia.coriolan.model.assertDeckCorrect
import com.ashalmawia.coriolan.model.assertExpressionCorrect
import com.ashalmawia.coriolan.model.mockCardData
...
class SqliteStorageTest {
    ...
    @Before
    fun before() {
        storage = SqliteStorage(RuntimeEnvironment.application)
    }
