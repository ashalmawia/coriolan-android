...
fun languageInfo(id: Long, value: String) = LanguageInfo(id.asLanguageId(), value)
fun domainInfo(id: Long, name: String, origLangId: Long, transLangId: Long) =
        DomainInfo(id.asDomainId(), name, origLangId.asLanguageId(), transLangId.asLanguageId())
...
fun termInfo(id: Long, value: String, languageId: Long, transcription: String?) =
        TermInfo(id.asTermId(), value, languageId.asLanguageId(), transcription)
