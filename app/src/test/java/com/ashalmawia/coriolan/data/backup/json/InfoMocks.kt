...
fun deckInfo(id: Long, domainId: Long, name: String) = DeckInfo(id, domainId.asDomainId(), name)
fun cardInfo(id: Long, deckId: Long, domainId: Long, originalId: Long, translationIds: List<Long>, cardType: CardType?) =
        CardInfo(id, deckId, domainId.asDomainId(), originalId, translationIds, cardType)
